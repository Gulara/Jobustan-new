...
//         }
//     }
//     function UpdateRemainingAge(isAdd5) {
//         if (isAdd5) {
//             remainingAge = remainingAge - 1;
//         } else {
//             remainingAge = remainingAge + 1;
//         }
...
//         if (remainingAge == 0) {
//             $('#qualificationAge').prop("disabled", true);
//             $('#qualificationAge').css({
//                 'opacity': '0.3'
//             });
//         } else {
//             $('#qualificationAge').prop("disabled", false);
//             $('#qualificationAge').css({
//                 'opacity': '1'
//             })
...
//     //         "<div class='qualification__div--item'><div class='qualification__div--top'>" +
//     //         "<div id='searchfield' class='searchfield'> <form><label class='mr-2' for='qualificationSkills'>Skills:</label><input type='text' name='currency' class='biginput qualificationSkills' id='qualificationSkills' class='qualificationLang'><label class='mx-2 m-t-10'> Level: </label> <div class='qualification-select-div m-t-10'> <select class='iq-languageLevel qualification__select' name='languageLevel'><option class='languageLevel_option' value='beginner' selected=''>Beginner</option><option class='languageLevel_option' value='elementary'>Elementary</option><option class='languageLevel_option' value='intermediate'>Intermediate</option><option class='languageLevel_option' value='upperIntermediate'>Upper Intermediate</option><option class='languageLevel_option' value='advanced'>Advanced</option><option class='experienceYears_option' value='proficient'>Proficient</option></select></div></form></div></div>" +
//     //         "<div class='qualification__div--bottom'>" +
//     //         "<div class='switch-block'>" +
//     //         "<label class='switch-light switch-candy'>" +
//     //         "<input type='checkbox' name='' id='' />" +
...
//     //             $('.qualificationSkills').autocomplete({
//     //                 lookup: languages,
//     //                 onSelect: function (suggestion) {
//     //                     var thehtml = '<strong>Currency Name:</strong> ' + suggestion.value + ' <br> <strong>Symbol:</strong> ' + suggestion.data;
//     //                     $('#outputcontent').html(thehtml);
...
//     //         "<div class='qualification__div--item'><div class='qualification__div--top'>" +
//     //         "<div id='searchfield' class='searchfield'> <form> <div class='d-flex  w-100 justify-content-between  align-items-center mr-5 '><label class='mx-2 m-t-10'> Min: </label> <div class='qualification-select-div m-t-10'> <select class='iq-ageLevel qualification__select' name='ageLevel'><option class='ageLevel_option' value='18' selected=''>18</option><option class='ageLevel_option' value='19'>19</option><option class='ageLevel_option' value='20'>20</option><option class='ageLevel_option' value='21'>21</option><option class='ageLevel_option' value='22'>22</option><option class='experienceYears_option' value='23'>23</option></select></div></div>  <div class='d-flex  w-100 justify-content-between align-items-center'><label class='mx-2 m-t-10'> Max: </label> <div class='qualification-select-div m-t-10'> <select class='iq-ageLevel qualification__select' name='ageLevel'><option class='ageLevel_option' value='30' selected=''>30</option><option class='ageLevel_option' value='31'>31</option><option class='ageLevel_option' value='32'>32</option><option class='ageLevel_option' value='33'>33</option><option class='ageLevel_option' value='60'>60</option><option class='experienceYears_option' value='65'>65</option></select></div></div></form></div></div>" +
//     //         "<div class='qualification__div--bottom'>" +
//     //         "<div class='switch-block'>" +
//     //         "<label class='switch-light switch-candy'>" +
//     //         "<input type='checkbox' name='' id='' />" +
...
//     //         UpdateRemainingAge(true);
//     //         $(".qualification__div").append(ageInput);
